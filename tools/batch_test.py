...
WORK_DIRS = 'work_dirs'
PRED_DIRS = 'output/predictions_v0.9.3'

# LaRS paper experiments
CONFIGS=[
...
# GENA paper experiments
# CONFIGS=[
    # ("gena_noaug_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_noaug.py"),
    # ("gena_defaug_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_defaug.py"),
    # ("gena_maxaug_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_maxaug.py"),
    # ("gena_genaug_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_genaug.py"),
    # ("gena_genaug_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_genaug.py"),
    # ("gena_genv2_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_genaug_v2.py"),
    # ("gena_genv3_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_genaug_v3.py"),
    # ("gena_genv4_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_genaug_v4.py"),
    # ("gena_genv5_t", "configs/segformer/segformer_mit-b2_8x1_768x768_160k_lars_genaug_v5.py"),
# ]
